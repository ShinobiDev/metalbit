<div class="modal fade" id="{{'confirmar_transaccion'.$ad->id_pago}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="overflow-y: scroll;" >
<div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form method="POST" action="{{route('confirmar_transaccion',[$ad->id_pago])}}">
                     <h3 style="text-align: center;" class="modal-title" id="exampleModalLabel"><b>¿Cómo calificarias a este anunciante?</b></h3>
                    {{csrf_field()}}
                    <input type="hidden" name="id_anuncio_calificar" value="{{$ad->id_anuncio}}">
                    <section class="clasificacion" style="text-align: center;" value="{{old('nota')}}"  required>
                        ...
                        <input id="rd5" class="" type="radio" name="nota" value="5" checked>
        ...
        <button  type="button" class="btn btn-primary" data-dismiss="modal" onclick="salir_modal('{{'infocalificar'.$ad->id}}')">SALIR</button>
      </div>
