          ...
          <table id="compras-table" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              @foreach ($pag as $transaccion)
                  ...
                  <tr id="row_{{$transaccion->id_pago}}">
                    <td class="bg-danger" ><h4><strong class="text-success">{{$transaccion->tipo_anuncio}}</strong></h4></td>
                     <td>
                      ...
                      @elseif(($transaccion->transactionState == 'Pago aceptado' || $transaccion->transactionState == 'Pago Aceptado') && $transaccion->estado_pago =='PENDIENTE')
                  ...
                  <td class="bg-info">
                    <span class="text-red">
                      {{$transaccion->code_wallet}}

                    </span>
                    @if($transaccion->image_wallet!="")
                          <a target="_blank" href="{{config('app.url')}}/archivos/{{$transaccion->image_wallet}}"><span class="text-primary">Ver wallet QR</span></a>
                        @endif
                  ...
                  <td >
                        ...
                        @if(($transaccion->transactionState == 'Pago aceptado' || $transaccion->transactionState == 'Pago Aceptado') && $transaccion->estado_pago =='PENDIENTE')
