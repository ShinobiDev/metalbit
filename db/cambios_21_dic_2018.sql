...
ALTER TABLE `pagos` ADD `transactionState` ENUM('Pendiente','Pago Aceptado','Moneda Envíada','Moneda Recibida','Pago a Comprador','Transacción Finalizada') NOT NULL DEFAULT 'Pendiente' AFTER `transactionStatePayU`;
#ESTA LINE ADEBE EJECUTARSE CAMBIADO EL VALOR APROBADO
